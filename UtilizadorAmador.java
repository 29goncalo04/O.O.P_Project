...
public class UtilizadorAmador extends Utilizador{
    ...
    public UtilizadorAmador(int codigo, String nome, int idade, int altura,int peso, String email, String morada,
    ...
    // Construtor de cópia
    public UtilizadorAmador(UtilizadorAmador myUtilizador){
        super(myUtilizador);
    }

    public double fatorMultiplicativo(int idade, int altura, char genero, int freq_cardiaca_media){
        // Bónus do tipo de utilizador
        return super.fatorMultiplicativo(idade, altura, genero, freq_cardiaca_media) * 1.00;
    }
